...
class SettingValueDialogAdapter(private val setting: ListSetting) : BaseAdapter() {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View? {
        parent ?: return null

        val view = convertView ?: LayoutInflater.from(parent.context).inflate(R.layout.item_setting_value, parent, false)

        view.findViewById<TextView>(R.id.tv_value).text = setting.possibleValues[position]
